    ...
    render(){
        return(
            <div>
                ...
                <input type="text" value={this.props.taskSummary} onChange={this.taskSummaryChanged}></input>
                <button className="stopped" type="submit" value="StartCountdown" onClick={this.startCountdownClick}/>
